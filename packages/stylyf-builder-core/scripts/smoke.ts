...
import { allocatePort, createProjectWorkspace, redact, runCommand } from "../src/index.js";
...
try {
  ...
  console.log(JSON.stringify({ ok: true, workspace: workspace.slug, port, result: result.exitCode }, null, 2));
} finally {
