...
export type ColumnVisibilityMenuProps = JSX.HTMLAttributes<HTMLElement> & {
  class?: string;
};
...
export function ColumnVisibilityMenu(userProps: ColumnVisibilityMenuProps) {
  ...
  return (
    <RegistryComponentShell item={registryItemBySlug["column-visibility-menu"]} class={local.class} {...others}>
      {local.children}
