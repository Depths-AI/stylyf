...
export type NotificationListProps = JSX.HTMLAttributes<HTMLElement> & {
  class?: string;
};
...
export function NotificationList(userProps: NotificationListProps) {
  ...
  return (
    <RegistryComponentShell item={registryItemBySlug["notification-list"]} class={local.class} {...others}>
      {local.children}
