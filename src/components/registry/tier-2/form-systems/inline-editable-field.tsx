...
export type InlineEditableFieldProps = JSX.HTMLAttributes<HTMLElement> & {
  class?: string;
};
...
export function InlineEditableField(userProps: InlineEditableFieldProps) {
  ...
  return (
    <RegistryComponentShell item={registryItemBySlug["inline-editable-field"]} class={local.class} {...others}>
      {local.children}
